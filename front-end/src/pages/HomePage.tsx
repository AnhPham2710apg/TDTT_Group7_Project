...
const HomePage = () => {
  ...
  // --- ĐỊNH NGHĨA DỮ LIỆU FEATURE (Chuyển vào trong để dùng t()) ---
  const featuresData = [
    {
      id: 1,
      title: t('home.feature_smart_title', "Smart Recommendations"),
      desc: t('home.feature_smart_desc', "Get personalized restaurant suggestions based on your taste."),
      icon: MapPin,
    ...
    {
      id: 2,
      title: t('home.feature_save_title', "Save Favorites"),
      desc: t('home.feature_save_desc', "Keep track of your favorite spots effortlessly."),
      icon: Heart,
    ...
    {
      id: 3,
      title: t('home.feature_route_title', "Optimized Routes"),
      desc: t('home.feature_route_desc', "Plan your food tour with smart routing to save time."),
      icon: Route,
    ...
    <div className="min-h-screen bg-background overflow-x-hidden">
      ...
      >
        ...
        <div className="container mx-auto text-center relative z-10">
          ...
          >
            {t('home.hero_desc', 'Find the best restaurants based on your preferences. Get personalized recommendations for your culinary adventure.')}
          </motion.p>
          ...
          >
            ...
            >
              {t('home.cta_explore', 'Start Exploring')}
            </Button>
            {!isLoggedIn && (
              <Button 
                size="lg" 
      ...
      <motion.section className="py-12 md:py-16 px-4 bg-muted/30">
        <div className="container mx-auto">
          <motion.h2 
            ...
            {...fadeUp}
          >
            {t('home.why_choose', 'Why Choose Food Tour Assistant?')}
          </motion.h2>
      ...
      <motion.section className="py-12 md:py-16 px-4 bg-muted/30">
        <div className="container mx-auto">
          <motion.h2 
            ...
            {...fadeUp}
          >
            {t('home.how_it_works', 'Hoạt động như thế nào?')}
          </motion.h2>
          ...
          <div className="grid lg:grid-cols-2 gap-8 md:gap-12 items-center">
            ...
            >
              {[
                { 
                    id: 1, 
                    title: t('about.mobile_step1_title', "Tìm kiếm thông minh"), 
                    desc: t('about.mobile_step1_desc', "Sử dụng bộ lọc chi tiết để tìm nhà hàng phù hợp.") 
                },
                { 
                    id: 2, 
                    title: t('about.mobile_step2_title', "Chọn và Lưu"), 
                    desc: t('about.mobile_step2_desc', "Lưu lại các địa điểm yêu thích vào danh sách của bạn.") 
                },
                { 
                    id: 3, 
                    title: t('about.mobile_step3_title', "Tối ưu hóa Lộ trình"), 
                    desc: t('about.mobile_step3_desc', "Tự động sắp xếp lịch trình di chuyển thuận tiện nhất.") 
                }
              ].map((step) => (
        ...
        <div className="container mx-auto text-center">
          ...
          >
            ...
            <h2 className="text-3xl font-bold mb-4">
              {t('home.cta_title', 'Ready to Start Your Food Journey?')}
            </h2>
            <p className="text-muted-foreground mb-6 max-w-xl mx-auto">
              {t('home.cta_desc', 'Join thousands of food lovers discovering amazing restaurants and creating unforgettable culinary experiences.')}
            </p>
            
            {!isLoggedIn && (
              <Button size="lg" className="bg-hero-gradient hover:opacity-90" onClick={() => navigate("/register")}>
                {t('home.cta_signup', 'Sign Up Free')}
              </Button>
            )}
          </motion.div>
        </div>
